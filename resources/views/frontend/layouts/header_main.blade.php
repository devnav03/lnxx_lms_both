...
@if($route == 'user-dashboard' || $route == 'personal-details' || $route == 'cm-details' || $route == 'product-requested' || $route == 'address-details' || $route ==  'select-services' || $route == 'thank-you' || $route == 'record-video' || $route == 'consent-approval' || $route == 'preference' || $route == 'consent' || $route == 'education-detail' || $route == 'credit-card-information' || $route == 'personal-loan-information' || $route == 'information-form' || $route == 'personal-loan-preference' || $route == 'all-relations' || $route == 'personal-loan-information-screen' || $route == 'applications-notification') 
    ...
    <div class="row">
      ...
      <div class="col-md-5">
        ...
        @else
          ...
          @if($route != 'personal-loan-information-screen')
...
<header class="header @if($user_base == 'Agent') agent_header @endif @if($route == 'my-profile') agent_header @endif">
  <div class="container">
    <div class="row">
      <div class="col-md-1"> 
        <div class="logo-main">
          <a href="{{ route('home') }}"><img src="{!! asset('assets/frontend/images/lnxx_logo.svg')  !!}" alt="logo" class="img-responsive"> </a>
        </div> 
      ...
      <div class="col-md-7">
        <ul class="left_menu">
          <li><a href="#abouttag">About Us</a></li>
           @if($user_base != 'Agent')
         
          <li><a href="sign-in">Credit Cards</a></li>
          <li><a href="sign-in">Personal Loan</a></li>
          <li><a href="sign-in">Business Loan</a></li>
          <li><a href="sign-in">Mortgage Loan</a></li>
            @endif
