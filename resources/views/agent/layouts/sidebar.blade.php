            ...
            <div class="main-sidebar-header main-container-1 active">
                ...
                <div class="main-sidebar-body main-body-1">
                    ...
                    <ul class="menu-nav nav">
                        <li class="nav-header"><span class="nav-label">Agent Dashboard</span></li>
                        ...
                        <li class="nav-item"><a href="{{ route('logout-agent') }}" class="nav-link with-sub"> <i class="ti-power-off sidemenu-icon menu-icon "></i><span class="sidemenu-label">Log Out</span></a></li>
