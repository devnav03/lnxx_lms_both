...
<div class="agile-grids">   
    <div class="grids">       
        <div class="row">
            <div class="col-md-12">                
                <h1 class="page-header">Services  <a style="background: #5EB495; border-color: #5EB495;" class="btn btn-sm btn-primary pull-right" href="{!! route('services.create') !!}"> <i class="fa fa-plus fa-fw"></i> Add New Service</a></h1>
                ...
                <div class="agile-tables">
                    <div class="w3l-table-info">
                        ...
                        <form action="{{ route('services.action') }}" method="post">
                        <!--     <div class="row"> -->
                           ...
                           <!--  </div> -->
                            <table id="paginate-load" data-route="{{ route('services.paginate') }}" class="table table-hover">
                            </table>
                        </form>
                    </div>
