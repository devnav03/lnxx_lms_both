...
<div class="agile-grids">   
    <div class="grids">       
        <div class="row">
            <div class="col-md-12">                
                <h1 class="page-header">Banks  <a style="background: #5EB495; border-color: #5EB495;" class="btn btn-sm btn-primary pull-right" href="{!! route('banks.create') !!}"> <i class="fa fa-plus fa-fw"></i> Add New Bank</a></h1>
                ...
                <div class="agile-tables">
                    <div class="w3l-table-info">
                        ...
                        <form action="{{ route('banks.action') }}" method="post">
                        <!--     <div class="row"> -->
                           ...
                           <!--  </div> -->
                            <table id="paginate-load" data-route="{{ route('banks.paginate') }}" class="table table-hover">
                            </table>
                        </form>
                    </div>
